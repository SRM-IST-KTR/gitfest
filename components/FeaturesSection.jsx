	...
	const features = [
		{
			...
			description:
				'Learn by building real projects with industry-standard tools and technologies',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
		...
		},
		{
			...
			description:
				'Walk away with a fully functional application for your portfolio',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
		...
		},
		{
			...
			description:
				'Work with the same tools used by top tech companies worldwide',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
		...
		},
		{
			...
			description:
				'Receive recognition for your participation and achievements',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
			...
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					...
					<h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
						Why Choose{' '}
						<span className="text-green-400">GitFest</span>?
					</h2>
					<p className="text-xl text-gray-300 max-w-3xl mx-auto">
						More than just a workshop - it&apos;s your gateway to
						professional development and practical industry
						experience.
					</p>
				</div>{' '}
