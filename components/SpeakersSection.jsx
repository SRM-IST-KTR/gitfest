    ...
    const speakers = [
        {
            ...
            bio: "Full-stack developer with 8+ years of experience building scalable applications. Passionate about open source and developer experience.",
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                        Learn from the
                        <span className="text-green-400 block">Best in Tech! 🚀</span>
                    </h2>
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                        Get ready to be inspired by industry experts who will share their knowledge,
                        experiences, and insider tips to help you level up your tech journey!
                    </p>
                </div>
