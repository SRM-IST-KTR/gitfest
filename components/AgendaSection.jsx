	...
	const agendaItems = [
		{
			...
			description:
				'Co-organized with Hack the Box SRM. Kickstart your journey with exciting cybersecurity challenges and problem-solving activities',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
		...
		},
		{
			...
			description:
				'Learn design principles and create stunning user interfaces using industry-standard tools',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
					...
					<path
						...
						strokeLinejoin="round"
						strokeWidth={2}
						d="M17 14v3a2 2 0 01-2 2h-2v-5h2a2 2 0 012 2z"
					/>
					<path
						strokeLinecap="round"
						strokeLinejoin="round"
						strokeWidth={2}
						d="M17 7v3a2 2 0 01-2 2h-2V5h2a2 2 0 012 2z"
					/>
					<circle
						cx="17"
						cy="10"
		...
		},
		{
			...
			description:
				'Build responsive and interactive user interfaces with modern frameworks and libraries',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
		...
		},
		{
			...
			description:
				'Create robust APIs and deploy your complete application to the cloud',
			icon: (
				<svg
					className="w-8 h-8"
					fill="none"
			...
			<div className="container mx-auto px-6 relative z-10">
				<div className="text-center mb-16">
					...
					<h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
						Four Days of{' '}
						<span className="text-green-400 animate-glow-green">
							Innovation
						</span>
					</h2>
					<p className="text-xl text-gray-300 max-w-3xl mx-auto">
						Experience a complete product development cycle from
						design to deployment through hands-on, interactive
						learning.
					</p>
				</div>{' '}
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
					{agendaItems.map((item, index) => (
						<div
							...
							<div
								className={`absolute inset-0 bg-gradient-to-r ${item.color} opacity-0 group-hover:opacity-5 rounded-2xl transition-opacity duration-300`}></div>
						</div>
					))}
				</div>
				{/* Bottom CTA */}
				<div className="text-center mt-16">
					...
					<p className="text-lg text-gray-300 max-w-2xl mx-auto">
						By the end of GitFest 2025, you&apos;ll have a{' '}
						<span className="font-semibold text-green-400">
							fully functional product
						</span>{' '}
						designed, developed, and deployed by you, plus valuable
						connections with industry professionals and fellow
						developers.
					</p>
				</div>
			</div>
