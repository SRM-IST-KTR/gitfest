                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center mb-6">
                            ...
                            <div className="text-3xl font-bold">
                                ...
                                <span className="text-lg text-gray-400 ml-2">2025</span>
                            </div>
                        </div>
                        <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                            A four-day product-building workshop designed to introduce students to real-world development through hands-on learning. Build, learn, and deploy with industry experts.
                        </p>
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-gray-300">
                            ...
                            <div className="flex items-start">
                                ...
                                <span>SRM Institute of Science and Technology<br />Kattankulathur, Tamil Nadu<br />Chennai, India</span>
                            </div>
                        </div>
                    </div>
                </div>
